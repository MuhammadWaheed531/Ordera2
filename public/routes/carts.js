...
//         else 
//         {
//             var sql = `INSERT INTO carts(user_id, product_name, image, qty, price, total, time, user_location, product_location) VALUES (${user_id}, ${product_name}, ${image}, ${qty},${price},${total},${time},${user},${product});`;
//             connection.query(sql, function(err, result){
//                 if(err)
//                 {
//                     throw err;
